      ...
      <section className="sticky top-0 mx-auto flex h-screen max-w-[1350px] flex-col items-center text-center  ">
        <div className="space-y-5 m-auto">
          <h1 className="tracking-wide space-y-3 text-5xl font-semibold lg:text-6xl xl:text-7xl ">
            <span className="block bg-gradient-to-r from-black/90 to-black/70 text-8xl bg-clip-text text-transparent p-3">
             AirPods
            </span>
            <span className="block bg-gradient-to-r from-black/75 to-black/80 bg-clip-text text-center text-transparent p-3">
              3rd generation
            </span>
        ...
        <div
         ...
         ">
          <Image
            src={"https://gcdnb.pbrd.co/images/reUrVDEt2nWN.jpg?o=1"}
            fill
            alt="macbook-pro"
